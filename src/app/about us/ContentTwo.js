        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-6 col-xs-12">
              <div className="content-two-img"><img src="images/5.png" /></div>
            </div>
            <div className="col-sm-6 col-xs-12">
              <div className="content-two_text">
                <h5>Welcome to FamilyPizza</h5>
                <h6> ABOUT US</h6><img src="images/18.png"  alt="..."/>
                ...
                <div className="main-icon"><i className="fa fa-facebook" /><i className="fa fa-twitter" /><i className="fa fa-google-plus" /><i className="fa fa-instagram" /></div>
